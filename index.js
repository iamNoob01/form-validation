...
function checkpassword(password) {
     if(password.length>8 && password.includes('.')){
          ...
          document.getElementById('password_error').innerText='password must contant 8 letters and include . operater'
     }
}
...
function checkcpassword(password, cpassword) {
     if(password==cpassword && password!=''){
          ...
          document.getElementById('cpassword_error').innerText='passsword did not matched'
     }
}